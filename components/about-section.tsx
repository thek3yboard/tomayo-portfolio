      ...
      <div className="max-w-[1400px] mx-auto px-8 md:px-16">
        <div className="mb-12">
          <div className="flex items-center gap-8 mb-8">
            <h2 className="font-sans font-semibold text-5xl">ABOUT</h2>
            <div className="flex-1 h-[2px] bg-black"></div>
          </div>
          <p className="font-sans text-xl max-w-[1200px]">
        ...
        <div>
          <div className="flex gap-6">
            <div className="flex flex-col items-center pt-2">
              ...
              <div className="w-[2px] flex-1 bg-[#6b1f1f] mt-1"></div>
            </div>
            <div className="flex-1 pb-12">
              <div className="mb-4">
                <h3 className="font-sans text-xl font-semibold">
                  Jr Graphic Designer <span className="font-light italic">in Fabricaciones Militares</span>
                </h3>
                <p className="font-sans text-xl font-light italic">jan. 2023 - jul. 2024</p>
              </div>
              <p className="font-sans text-xl mb-4">
              ...
              <p className="font-sans font-light text-xl italic">
          ...
          <div className="flex gap-6">
            ...
            <div className="flex-1">
              <div className="mb-4">
                <h3 className="font-sans text-xl font-semibold">
                  Administrative Assistant <span className="font-light italic">in Fabricaciones Militares</span>
                </h3>
                <p className="font-sans text-xl font-light italic">oct. 2021 - jan. 2023</p>
              </div>
              <p className="font-sans text-xl mb-4">
                In the Architecture and Infrastructure field, I carried out administrative tasks such as preparing Excel 
                spreadsheets, managing construction project documentation, designing and exporting plans, and communicating 
                with construction companies and handling budget proposals.
              </p>
              <p className="font-sans font-light text-xl italic">
                Photoshop | Illustrator | Project management | Coorporative Relations
              </p>
